...
<head>
  ...
  <link rel="stylesheet" href="/FastJavaProject/js/masonry/style.css" />
...
<body class="demos ">
  ...
  <nav id="site-nav">
    ...
    <ul class="demos-list">
        ...
        <li class="current"><a href="#content">Infinite Scroll</a></li>
...
<script src="/FastJavaProject/js/jquery-1.7.1.min.js"></script>
<script src="/FastJavaProject/js/masonry/jquery.masonry.js"></script>
<script src="/FastJavaProject/js/masonry/jquery.infinitescroll.min.js"></script>
<script>
  $(function(){
    ...
    $container.infinitescroll({
      ...
      loading: {
    	  ...
    	  alert("ddd");
    	  var sss = ' <div class="box col2"> ' +
    		    '<p>Vestibulum volutpat, lacus a ultrices sagittis,</p>'+
    		    '<p>Fusce accumsan mollis eros. Pellentesque a diam sit amet mi ullamcorper vehicula  </p>'+
    		    '<p>Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis.</p>'+
    		  '</div>';
    	  $container.masonry( 'appended', sss, true ); 
      }
    );
